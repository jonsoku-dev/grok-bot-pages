...
### [2026-08-23 AI Engineering Radar](/blog/2026/08/23/ai-engineering-radar)
...
- 분류: AI 엔지니어링
- 추천: **작게 실험**
- 근거 레코드: 8건 — `beet-code`, `marm-memory`, `nika`, `pgroonga-mcp`, `staddress-mcp`, `nomadamas-jikji`, `nomadamas-k-skill`, `toss-llm-serving`
- 공개 원문: [원문 1](https://github.com/Mesutcydev/beet-code) · [원문 2](https://github.com/Lyellr88/marm-memory) · [원문 3](https://github.com/supernovae-st/nika) · [원문 4](https://github.com/askdkc/pgroonga-mcp) · [원문 5](https://zenn.dev/staddress/articles/b601f14a21c5c5)

### [2026-08-23 AX Intelligence](/blog/2026/08/23/ax-intelligence)
...
- 분류: AX 인텔리전스
- 추천: **읽기**
- 근거 레코드: 3건 — `nordre-follo-hearing-agent`, `mufg-ai-flowchart`, `shinhan-securities-contract-agent`
- 공개 원문: [원문 1](https://www.technologyrecord.com/article/nordre-follo-municipality-modernises-public-hearing-workflows-with-microsoft-copilot-studio) · [원문 2](https://www.itmedia.co.jp/enterprise/articles/2608/21/news019.html) · [원문 3](https://www.yna.co.kr/view/AKR20260818061300017)
