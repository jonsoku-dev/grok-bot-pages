...
- 분류: AI 엔지니어링
- 추천: **작게 실험**
- 근거 레코드: 8건 — `toss-llm-serving`, `nomadamas-jikji`, `nomadamas-k-skill`, `staddress-mcp`, `pgroonga-mcp`, `marm-memory`, `beet-code`, `nika`
- 공개 원문: [원문 1](https://toss.tech/article/tech_talk_talk_2) · [원문 2](https://github.com/NomaDamas/jikji) · [원문 3](https://github.com/NomaDamas/k-skill) · [원문 4](https://zenn.dev/staddress/articles/b601f14a21c5c5) · [원문 5](https://github.com/askdkc/pgroonga-mcp)
...
- 분류: AX 인텔리전스
- 추천: **읽기**
- 근거 레코드: 3건 — `shinhan-securities-contract-agent`, `mufg-ai-flowchart`, `nordre-follo-hearing-agent`
- 공개 원문: [원문 1](https://www.yna.co.kr/view/AKR20260818061300017) · [원문 2](https://www.fnnews.com/news/202608181028437199) · [원문 3](https://www.itmedia.co.jp/enterprise/articles/2608/21/news019.html) · [원문 4](https://www.technologyrecord.com/article/nordre-follo-municipality-modernises-public-hearing-workflows-with-microsoft-copilot-studio) · [원문 5](https://www.atea.no/kundereferanser/norde-follo-kommune-1/?pid=3b1733d9-adef-4b74-8b69-2cedb52ea3ec)

## 어떻게 읽을까

- 제목과 설명으로 읽을 글을 고릅니다.
- `추천`은 읽기·지켜보기·작게 실험 등 현재 판단이며 자동 도입 결정이 아닙니다.
- 근거 레코드와 공개 원문은 주장을 다시 확인할 때 사용합니다.

## 데이터와 글의 역할

관찰·검증 세부 필드는 `intelligence/signals/**`에 보존합니다. 독자용 글은 그 데이터를 그대로 노출하지 않고 핵심 내용, 추천 이유, 주의할 점과 다음 단계로 편집합니다.
